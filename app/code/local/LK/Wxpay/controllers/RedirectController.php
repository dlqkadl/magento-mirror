<?php
class LK_Wxpay_RedirectController extends Mage_Core_Controller_Front_Action {
                ...
                ?>
                    <html>
                        <head>
                            ...
                            <link rel="stylesheet" href="<?php echo Mage::getDesign()->getSkinUrl('lk/css/QRcode_Pay.css')?>">
